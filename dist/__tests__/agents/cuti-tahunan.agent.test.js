...
describe('CutiTahunanAgent', () => {
    ...
    describe('generateCutiTahunan', () => {
        ...
        it('should throw error if cuti tahunan already exists', async () => {
            ...
            await expect(cutiTahunanAgent.generateCutiTahunan(karyawanId, 2026)).rejects.toThrow(BusinessLogicError);
        });
        it('should carry forward sisa cuti from previous year', async () => {
            ...
            expect(cutiTahunan2026.totalHakCuti).toBe(cutiTahunan2026.jatahDasar + cutiTahunan2026.carryForward);
        });
    ...
    describe('findByKaryawanAndTahun', () => {
        ...
        it('should throw NotFoundError if not found', async () => {
            await expect(cutiTahunanAgent.findByKaryawanAndTahun(karyawanId, 2099)).rejects.toThrow(NotFoundError);
        });
    });
    describe('updateSaldo', () => {
        ...
        it('should throw error if insufficient saldo', async () => {
            const cutiTahunan = await cutiTahunanAgent.generateCutiTahunan(karyawanId, 2026);
            await expect(cutiTahunanAgent.updateSaldo(cutiTahunan.id, 999, 'subtract')).rejects.toThrow(BusinessLogicError);
        });
    });
