...
describe('PembelianAgent', () => {
    ...
    describe('findAll', () => {
        it('should get all pembelian with pagination', async () => {
            const result = await pembelianAgent.findAll(undefined, undefined, undefined, undefined, undefined, 1, 10);
        ...
        it('should filter pembelian by supplier', async () => {
            const result = await pembelianAgent.findAll(undefined, undefined, 'Sejahtera', undefined, undefined, 1, 10);
    ...
    describe('getRekapPembelian', () => {
        it('should get rekap by item', async () => {
            const rekap = await pembelianAgent.getRekapPembelian(undefined, '2026-01-01T00:00:00Z', '2026-01-31T23:59:59Z', 'item');
        ...
        it('should get rekap by supplier', async () => {
            const rekap = await pembelianAgent.getRekapPembelian(undefined, '2026-01-01T00:00:00Z', '2026-01-31T23:59:59Z', 'supplier');
            expect(rekap).toBeDefined();
            expect(rekap.rekap).toBeInstanceOf(Array);
        });
        it('should filter rekap by kategori', async () => {
            const rekap = await pembelianAgent.getRekapPembelian('ATK', '2026-01-01T00:00:00Z', '2026-01-31T23:59:59Z', 'item');
            expect(rekap).toBeDefined();
        });
    });
});
