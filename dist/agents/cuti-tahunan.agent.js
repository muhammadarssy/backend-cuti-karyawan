...
export class CutiTahunanAgent {
     ...
     */
    async generateCutiTahunan(karyawanId, tahun) {
     ...
     */
    async generateCutiTahunanBulk(tahun) {
     ...
     */
    async findByKaryawanAndTahun(karyawanId, tahun) {
     ...
     */
    async updateSaldo(cutiTahunanId, jumlahHari, operation) {
        ...
        const newCutiTerpakai = operation === 'subtract'
