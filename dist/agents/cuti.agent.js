...
import { calculateWorkingDays, getYearFromDate, parseDate, validateDateRange, } from '../utils/date.js';
...
export class CutiAgent {
     ...
     */
    async findAll(karyawanId, jenis, tahun, page = 1, limit = 20) {
     ...
     */
    async getRekapAlasanCuti(tahun) {
     ...
     */
    async getSummaryByKaryawan(karyawanId, tahun) {
