...
export class PembelianAgent {
     ...
     */
    async findAll(itemId, kategori, supplier, tanggalMulai, tanggalSelesai, page = 1, limit = 20) {
    ...
    async delete(id) {
        ...
        if (pembelian.item.stokSekarang < pembelian.jumlah) {
            throw new BusinessLogicError('Stok tidak cukup untuk rollback pembelian. Stok saat ini: ' +
     ...
     * Get rekap pembelian
     */
    async getRekapPembelian(kategori, tanggalMulai, tanggalSelesai, groupBy = 'item') {
